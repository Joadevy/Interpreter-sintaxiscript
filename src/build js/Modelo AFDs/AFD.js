...
const tsFuncionTransicion = (estados, alfabeto, tablaTransiciones) => {
    ...
    tablaTransiciones.push([estados[0],
        { "simbolo": alfabeto[0],
    ...
    tablaTransiciones.push([estados[1],
        { "simbolo": alfabeto[0],
    ...
    tablaTransiciones.push([estados[1],
        { "simbolo": alfabeto[2],
            "estadoSiguiente": estados[2] }]);
    tablaTransiciones.push([estados[2],
        { "simbolo": alfabeto[0],
            "estadoSiguiente": estados[2] }]);
    tablaTransiciones.push([estados[2],
        { "simbolo": alfabeto[1],
...
const tsEsValida = (estadoInicial, estadosFinales, tablaTransiciones, cadena) => {
    ...
    for (let caracter of cadena) {
        estadoActual = tablaTransiciones
            ...
            .find(transicion => transicion[1].simbolo == tsCarAsimb(caracter))[1].estadoSiguiente;
    }
...
function tsmain() {
    ...
    const resultado = tsEsValida(estadoInicial, estadosFinales, tablaTransiciones, cadena);
    if (resultado) {
